...
class BybitFormats:
    ...
    def create_limit_simple(self, side: str, price: str, qty: str, sl: str, tp: str) -> Dict:
        """
        Creates a dictionary payload for a limit order.
    ...
    def create_reduce_limit(self, side: str, price: str, qty: str) -> Dict:
        """
        Creates a dictionary payload for a limit order.
    ...
    def create_simple_amend(self, orderId: str, price: str) -> Dict:
        """
        Creates a dictionary payload for amending an existing order.
    ...
    def create_sl_tp(self, sl: float, **kwargs) -> Dict:
        """
        Creates a dictionary payload for amending the sl and tp of a current position in the symbol that is passed.
        ...
        -------
        Dict
            A dictionary formatted to set the sl on a current position request.
        """
        return {
            **self._base_, 
            "tpslMode": "Full",
